    ...
    return (
      ...
      <div className="mainPortfolio-product-display-container">
        ...
        <div className="mainPortfolio-carousel-container">
            <button className="mainPortfolio-carousel-arrow mainPortfolio-left-arrow" onClick={prevImage}><ArrowBackIcon/></button>
            <div className="mainPortfolio-carousel-images" style={{ transform: `translateX(-${currentIndex * 100}%)` }}>
            ...
            <button className="mainPortfolio-carousel-arrow mainPortfolio-right-arrow" onClick={nextImage}><ArrowForwardIcon/></button>
        </div>
      </div>
      </>
    );
